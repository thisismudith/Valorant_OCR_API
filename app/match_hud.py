...
class Match():
    ...
    def get_weapon(self, side_attack: bool, lower_limit: int, upper_limit: int):
        ...
        for gun in gun_list:
            res = compare_images(gun_img, cv2.imread(r'..\assets\guns_tab\{}.png'.format(gun), cv2.IMREAD_GRAYSCALE))
    ...
    def get_shield(self, side_attack: bool, lower_limit: int, upper_limit: int):
        ...
        for shield in shield_list:
            res = compare_images(shield_img, cv2.imread(r'..\assets\shields_tab\{}.png'.format(shield), cv2.IMREAD_GRAYSCALE))
